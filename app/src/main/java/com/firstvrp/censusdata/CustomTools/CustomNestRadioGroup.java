package com.firstvrp.censusdata.CustomTools;
...
public class CustomNestRadioGroup extends LinearLayout {
			...
			((RadioButton) child).setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					if(mOnCheckedChangeListener != null){
						mOnCheckedChangeListener.onCheckedChanged(CustomNestRadioGroup.this, child.getId());
					}
					return true;
				}
			});
				...
				if (view instanceof RadioButton) {
					...
					((RadioButton) button).setOnTouchListener(new OnTouchListener() {
						...
						public boolean onTouch(View v, MotionEvent event) {
							...
							if(mOnCheckedChangeListener != null){
								mOnCheckedChangeListener.onCheckedChanged(CustomNestRadioGroup.this, button.getId());
							}
							return true;
						}
					});
	...
	private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
			if (parent == CustomNestRadioGroup.this && child instanceof RadioButton) {
				int id = child.getId();
